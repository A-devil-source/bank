...
<meta name="author" content="Lucky SArathe">
...
<section class="page-footer">
    ...
    <div class="footer-bottom">
        <p class="footer-content">Designed & Developed with <i class="fa fa-clock-o" style="color: red;"></i> by <a href="devloper.html">Lucky Sarathe</a></p>
    </div>
</section>
</body>
</html> 
